                        ...
                        <form method="POST" action="{{ route('dashboard.grades.create') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label>Grade</label>
                                    <input type="text" name="grade" value="{{old('grade')}}" class="form-control" placeholder="A">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Minimum</label>
                                    <input type="text" name="min" value="{{old('min')}}" class="form-control" placeholder="70">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Maximum</label>
                                    <input type="text" name="max" value="{{old('max')}}" class="form-control" placeholder="100">
                                </div>
                            </div>
